...
struct PlanCard: View {
    ...
    #if DEBUG
    static let reasonsInitiallyExpanded = ProcessInfo.processInfo.environment["LOCALLAB_EXPAND_REASONS"] == "1"
    #else
    ...
    var body: some View {
        GroupBox {
            ...
            Label("Smart Fit plan for this Mac", systemImage: "cpu")
        }
    }
...
struct ProvenanceBadge: View {
    ...
    private var label: String {
        ...
        case .autoMachine: "Smart Fit"
        case .autoInput: "from the file"
