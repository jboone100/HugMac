...
/// The SeedVR2 checkpoints LocalLab can install, cheapest first.
///
...
/// Fixed properties of the SeedVR2 architecture, as ported in `LocalLabMLX`.
...
public struct SeedVR2Resolver: Sendable {
    ...
    /// The engine whose measurements apply. Defaults to LocalLab's MLX engine.
    ...
    /// Keeps the app's first name (HugMac, until 2026-09-18): it labels every stored
    /// measurement and the bundled reference Mac's, and renaming it would orphan them.
